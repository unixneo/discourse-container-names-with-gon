...
after_initialize do
  module ::DiscourseContainerNames
    class << self
      ...
      def diskspace
        ...
        begin
          ...
          Rails.logger.warn("DiscourseContainerNames: Error getting disk space: #{e.message}")
          "error"
        end
      end
      ...
      def load_average
        ...
        begin
          ...
          Rails.logger.warn("DiscourseContainerNames: Error getting load average: #{e.message}")
          "error"
        end
      end
    ...
    class Engine < ::Rails::Engine
      engine_name "discourse-container-names-with-gon"
      isolate_namespace DiscourseContainerNames
    end

    class ContainerInfoController < ::ApplicationController
      requires_plugin DiscourseContainerNames::PLUGIN_NAME
  ...
  # Add container info to the site serializer so it's available to staff
